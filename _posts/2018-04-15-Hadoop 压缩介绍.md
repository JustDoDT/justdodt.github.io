...
![集群状况的压缩规则](/img/hadoop_compress/compress1)
...
**压缩比**    
![压缩比](/img/hadoop_compress/compress2)

**压缩时间**
![压缩时间](/img/hadoop_compress/compress3)
...
![时间/空间的权衡](/img/hadoop_compress/compress4)
...
### 压缩在MapReduce中的应用
![压缩在MR中的应用](/img/hadoop_compress/compress5)
...
![hadoop-bzip2分片1](/img/hadoop_compress/compress6)
...
![hadoop-bzip2分片2](/img/hadoop_compress/compress7)
